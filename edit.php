...
include("dbconnect.php");
	...
	if(isset($_GET['id']))
	{
		...
		if(isset($_POST['submit']))
		{
			    $n=$_POST['name'];
				$p=$_POST['prise'];
				$q="UPDATE dishes set Dish_Name='$n',Prise='$p' WHERE id='$edit_id'";
				...
				<div class="col-md-12 text-center">
					<div class="display-t js-fullheight">
						<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
							<h1>The Best Coffee <em>&amp;</em> Restaurant <em>in</em> Nashik</h1>
							<h2><a href="dishes.php" target="_blank">See Your Dishes List</a></h2><br><br><br>
<form name="f1" action="#" method="post" onsubmit="return validate()">		
  <fieldset>
    <h2 style="color: white">Edit Dish</h2>
    <div class="row">
     ...
     <div class="row">
        ...
        <div class="col-lg-6">
        	<input type="text" class="form-control" name="prise" placeholder="Enter Dish Prise">
        </div>
    </div>

    
    <button type="submit" name="submit" class="btn btn-primary">Edit Dish</button>
  </fieldset>
</form>
						</div>
					</div>
